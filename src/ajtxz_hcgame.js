ajtxz_hcgame.game = function () {
    ...
    var game = function (options) {
        ...
        this.init = function () {
            ...
            _pGame.state.add('lvl1_2', new ajtxz_hcgame.level1_2);
            _pGame.state.add('lvl1_3', new ajtxz_hcgame.level1_3);
            _pGame.state.add('lvl2_1', new ajtxz_hcgame.level2_1);
            _pGame.state.add('lvl2_2', new ajtxz_hcgame.level2_2);
            _pGame.state.add('lvl2_3', new ajtxz_hcgame.level2_3);
            _pGame.state.add('lvl3_1', new ajtxz_hcgame.level3_1);
            _pGame.state.add('lvl3_2', new ajtxz_hcgame.level3_2);
            _pGame.state.add('lvl3_3', new ajtxz_hcgame.level3_3);
            _pGame.state.add('lvl4_1', new ajtxz_hcgame.level4_1);
            _pGame.state.add('lvl4_2', new ajtxz_hcgame.level4_2);
            _pGame.state.add('lvl4_3', new ajtxz_hcgame.level4_3);
            _pGame.state.add('lvl5_1', new ajtxz_hcgame.level5_1);
            _pGame.state.add('lvl5_2', new ajtxz_hcgame.level5_2);
            _pGame.state.add('lvl5_3', new ajtxz_hcgame.level5_3);
